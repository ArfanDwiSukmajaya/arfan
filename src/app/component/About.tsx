...
function About() {
  return (
    <div id="about" className="py-12 md:py-24 px-4 md:px-8">
      ...
      <div className="w-full max-w-[90vw] md:max-w-[70vw] mx-auto bg-white rounded-2xl border shadow-2xs p-8 md:p-10">
        <div className="flex flex-col md:flex-row items-center md:items-start">
          ...
          <div className="md:w-1/2 flex bg-amber-50 justify-center items-center h-[300px] md:h-[400px] relative group">
            ...
            <div className="absolute w-44 h-16 md:w-64 md:h-20 bg-white rounded-xl shadow-lg border border-gray-200 p-3 md:p-4 flex items-center justify-start z-10 -rotate-6 transform origin-bottom-left transition-transform duration-300 ease-out will-change-transform hover:-translate-y-2 hover:-rotate-3 hover:shadow-xl"
              style={{ top: '10%', left: '10%' }}>
              {/* Konten Kartu */}
              <div className="flex items-center">
                <span className="inline-block w-4 h-4 bg-purple-500 rounded-full mr-3"></span>
                <span className="text-xs md:text-sm font-semibold text-gray-800">Thinking</span>
              </div>
            </div>

            {/* Card 2: Tengah */}
            <div className="absolute w-44 h-16 md:w-64 md:h-20 bg-white rounded-xl shadow-lg border border-gray-200 p-3 md:p-4 flex items-center justify-start z-20 rotate-3 transform origin-top-right transition-transform duration-300 ease-out will-change-transform hover:-translate-y-2 hover:rotate-6 hover:shadow-xl"
              style={{ top: '30%', left: '25%' }}>
              {/* Konten Kartu */}
              <div className="flex items-center">
                <span className="inline-block w-4 h-4 bg-orange-500 rounded-full mr-3"></span>
                <span className="text-xs md:text-sm font-semibold text-gray-800">Design</span>
              </div>
            </div>

            {/* Card 3: Paling Depan */}
            <div className="absolute w-44 h-16 md:w-64 md:h-20 bg-white rounded-xl shadow-lg border border-gray-200 p-3 md:p-4 flex items-center justify-start z-30 transition-transform duration-300 ease-out will-change-transform hover:-translate-y-2 hover:rotate-3 hover:shadow-xl"
              style={{ top: '50%', left: '15%' }}>
              {/* Konten Kartu */}
              <div className="flex items-center">
                <span className="inline-block w-4 h-4 bg-blue-500 rounded-full mr-3"></span>
                <span className="text-xs md:text-sm font-semibold text-gray-800">Execution</span>
              </div>
            </div>
          </div>
        </div>
