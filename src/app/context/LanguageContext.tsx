  ...
  const t = (key: string): string => {
    const translations: Record<string, Record<string, string>> = {
      id: {
        ...
        'project.wmp_gnow.description': 'Sebuah sistem manajemen pembelajaran komprehensif yang dirancang khusus untuk pengalaman laboratorium siswa. Fitur utamanya mencakup pelacakan kehadiran, koding Arduino secara langsung, dan sesi virtual interaktif.',
